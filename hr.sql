...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 27 Mai 2020 à 19:36
...
INSERT INTO `countries` (`COUNTRY_ID`, `COUTRY_NAME`, `REGION_ID`) VALUES
('AR', 'Argentina', 2),
('AU', 'Australia', 3),
('BE', 'Belgium', 1),
('BR', 'Brazil', 2),
...
CREATE TABLE IF NOT EXISTS `departments` (
  `DEPARTEMENT_ID` int(20) NOT NULL,
...
INSERT INTO `departments` (`DEPARTEMENT_ID`, `DEPARTMENT_NAME`, `MANAGER_ID`, `LOCATION_ID`) VALUES
...
CREATE TABLE IF NOT EXISTS `employees` (
  ...
  `COMMISSION_PCT` int(20) DEFAULT NULL,
  `MANAGER_ID` int(20) DEFAULT NULL,
  `DEPARTMENT_ID` int(90) DEFAULT NULL,
...
--
-- Structure de la table `jobe_history`
--

CREATE TABLE IF NOT EXISTS `jobe_history` (
  `EMPLOYEE_ID` int(20) NOT NULL,
...
--
-- Contenu de la table `jobe_history`
--

INSERT INTO `jobe_history` (`EMPLOYEE_ID`, `START_DATE`, `END_DATE`, `JOB_ID`, `DEPARTEMENT_ID`) VALUES
...
INSERT INTO `local` (`LOCATION_ID`, `STREET_ADDRESS`, `POSTAL_CODE`, `CITY`, `STATE_PROVINCE`, `COUNTRY_ID`) VALUES
